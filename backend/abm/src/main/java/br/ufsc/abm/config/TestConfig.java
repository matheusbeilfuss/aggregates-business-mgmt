...
import br.ufsc.abm.model.Expense;
import br.ufsc.abm.model.FixedExpense;
...
import br.ufsc.abm.model.enums.PaymentMethodEnum;
import br.ufsc.abm.model.enums.PaymentStatusEnum;
import br.ufsc.abm.model.enums.PhoneTypeEnum;
import br.ufsc.abm.repository.AddressRepository;
import br.ufsc.abm.repository.CategoryRepository;
import br.ufsc.abm.repository.ClientRepository;
import br.ufsc.abm.repository.ExpenseRepository;
import br.ufsc.abm.repository.FixedExpenseRepository;
import br.ufsc.abm.repository.FuelRepository;
import br.ufsc.abm.repository.OrderAddressRepository;
import br.ufsc.abm.repository.OrderRepository;
import br.ufsc.abm.repository.PaymentRepository;
import br.ufsc.abm.repository.PhoneRepository;
import br.ufsc.abm.repository.PriceRepository;
import br.ufsc.abm.repository.ProductRepository;
import br.ufsc.abm.repository.ProductSupplierRepository;
import br.ufsc.abm.repository.StockRepository;
import br.ufsc.abm.repository.SupplierRepository;
