...
import br.ufsc.abm.controller.exception.StandardError;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, AuthenticationEntryPoint authenticationEntryPoint, AccessDeniedHandler accessDeniedHandler) throws Exception {
		...
		return httpSecurity
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers(HttpMethod.GET, "/actuator/health").permitAll()						.requestMatchers(HttpMethod.GET, "/settings").permitAll()
						...
						.requestMatchers(HttpMethod.PATCH, usersRoutes).authenticated()
